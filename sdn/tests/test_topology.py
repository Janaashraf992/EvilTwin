...
RUN_MININET_TESTS = os.getenv("RUN_MININET_TESTS") == "1"

pytestmark = pytest.mark.skipif(
    not HAS_MININET or not RUN_MININET_TESTS,
    reason="Mininet topology tests require Mininet plus RUN_MININET_TESTS=1",
)
